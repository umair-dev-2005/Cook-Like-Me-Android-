...
class HomeVideoDescription extends StatelessWidget {
  const HomeVideoDescription({
    super.key,
  });
          ...
          Row(
            children: [
              ...
              CustomRoundedContainer(
                width: 60.w, height: 24.h,
                borderColor: AppColors.white,
                borderRadius: AppSizes.borderRadiusXXSmall-3,
                child: Center(
                  child: Text(AppTexts.follow, style: AppTextStyles.captionTextStyle
